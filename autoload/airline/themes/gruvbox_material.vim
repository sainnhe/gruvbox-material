...
if &background ==# 'light'
    ...
    let s:N2 = [ '#ddc39c' , s:darkgrey , 223 , s:darkgrey_cterm ] " info
    let s:N3 = [ '#ddc39c' , s:darker , 223 , s:darker_cterm ] " statusline

    let g:airline#themes#gruvbox_material#palette.normal = airline#themes#generate_color_map(s:N1, s:N2, s:N3)
    let g:airline#themes#gruvbox_material#palette.normal_modified = {
                \ 'airline_c': [ '#ddc39c' , s:darker , 223 , s:darker_cterm ] ,
                \ }

    " Insert mode
    let s:I1 = [ '#282828' , '#a9b665' , 235 , 142 ]
    let s:I2 = [ '#ddc39c' , s:darkgrey , 223 , s:darkgrey_cterm ]
    let s:I3 = [ '#ddc39c' , s:darker , 223 , s:darker_cterm ]
    ...
    let s:R2 = [ '#ddc39c' , s:darkgrey , 223 , s:darkgrey_cterm ]
    let s:R3 = [ '#ddc39c' , s:darker , 223 , s:darker_cterm ]
    ...
    let s:V2 = [ '#ddc39c' , s:darkgrey , 223 , s:darkgrey_cterm ]
    let s:V3 = [ '#ddc39c' , s:darker , 223 , s:darker_cterm ]
    ...
    " Inactive
    let s:IA = [ '#ddc39c' , s:darker , 223 , s:darker_cterm ]
    let g:airline#themes#gruvbox_material#palette.inactive = airline#themes#generate_color_map(s:IA, s:IA, s:IA)
    let g:airline#themes#gruvbox_material#palette.inactive_modified = {
                \ 'airline_c': [ '#ddc39c' , s:darker , 223 , s:darker_cterm ] ,
                \ }
