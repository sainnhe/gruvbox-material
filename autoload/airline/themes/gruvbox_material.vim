...
if &background ==# 'light'
    ...
    let s:N2 = [ '#603f2c' , s:darkgrey , 241 , 250 ] " info
    let s:N3 = [ '#603f2c' , s:darker , 241 , 223 ] " statusline
    ...
    let g:airline#themes#gruvbox_material#palette.normal_modified = {
                \ 'airline_c': [ '#603f2c' , s:darker , 241 , 223 ] ,
                \ }

    " Insert mode
    let s:I1 = [ '#ebdbb2' , '#6f8352' , 223 , 100 ]
    let s:I2 = [ '#603f2c' , s:darkgrey , 241 , 250 ]
    let s:I3 = [ '#603f2c' , s:darker , 241 , 223 ]
    ...
    let s:R2 = [ '#603f2c' , s:darkgrey , 241 , 250 ]
    let s:R3 = [ '#603f2c' , s:darker , 241 , 223 ]
    ...
    let s:V2 = [ '#603f2c' , s:darkgrey , 241 , 250 ]
    let s:V3 = [ '#603f2c' , s:darker , 241 , 223 ]
    ...
    " Inactive
    let s:IA = [ '#603f2c' , s:darker , 241 , 223 ]
