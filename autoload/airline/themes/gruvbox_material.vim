...
if &background ==# 'light'
    ...
    if get(g:, 'gruvbox_material_background', 'medium') ==# 'hard'
        ...
        let s:darker_cterm    = 235
        let s:darkgrey_cterm  = 239
    elseif get(g:, 'gruvbox_material_background', 'medium') ==# 'medium'
        let s:darker    = '#32302f'
        let s:darkgrey  = '#5a524c'
        let s:darker_cterm    = 236
        let s:darkgrey_cterm  = 240
    elseif get(g:, 'gruvbox_material_background', 'medium') ==# 'soft'
        let s:darker    = '#3c3836'
        let s:darkgrey  = '#665c54'
        let s:darker_cterm    = 237
        let s:darkgrey_cterm  = 241
    endif
endif
...
if &background ==# 'light'
    ...
    let s:N2 = [ '#5e4536' , s:darkgrey , 241 , 250 ] " info
    let s:N3 = [ '#5e4536' , s:darker , 241 , 223 ] " statusline
    ...
    let g:airline#themes#gruvbox_material#palette.normal_modified = {
                \ 'airline_c': [ '#5e4536' , s:darker , 241 , 223 ] ,
                \ }

    " Insert mode
    let s:I1 = [ '#ebdbb2' , '#6f8352' , 223 , 100 ]
    let s:I2 = [ '#5e4536' , s:darkgrey , 241 , 250 ]
    let s:I3 = [ '#5e4536' , s:darker , 241 , 223 ]
    ...
    let s:R2 = [ '#5e4536' , s:darkgrey , 241 , 250 ]
    let s:R3 = [ '#5e4536' , s:darker , 241 , 223 ]
    ...
    let s:V2 = [ '#5e4536' , s:darkgrey , 241 , 250 ]
    let s:V3 = [ '#5e4536' , s:darker , 241 , 223 ]
    ...
    " Inactive
    let s:IA = [ '#5e4536' , s:darker , 241 , 223 ]
    ...
    let s:N2 = [ '#d8be95' , s:darkgrey , 223 , s:darkgrey_cterm ] " info
    let s:N3 = [ '#d8be95' , s:darker , 223 , s:darker_cterm ] " statusline

    let g:airline#themes#gruvbox_material#palette.normal = airline#themes#generate_color_map(s:N1, s:N2, s:N3)
    let g:airline#themes#gruvbox_material#palette.normal_modified = {
                \ 'airline_c': [ '#d8be95' , s:darker , 223 , s:darker_cterm ] ,
                \ }

    " Insert mode
    let s:I1 = [ '#282828' , '#a9b665' , 235 , 142 ]
    let s:I2 = [ '#d8be95' , s:darkgrey , 223 , s:darkgrey_cterm ]
    let s:I3 = [ '#d8be95' , s:darker , 223 , s:darker_cterm ]
    ...
    let s:R2 = [ '#d8be95' , s:darkgrey , 223 , s:darkgrey_cterm ]
    let s:R3 = [ '#d8be95' , s:darker , 223 , s:darker_cterm ]
    ...
    let s:V2 = [ '#d8be95' , s:darkgrey , 223 , s:darkgrey_cterm ]
    let s:V3 = [ '#d8be95' , s:darker , 223 , s:darker_cterm ]
    ...
    " Inactive
    let s:IA = [ '#d8be95' , s:darker , 223 , s:darker_cterm ]
    let g:airline#themes#gruvbox_material#palette.inactive = airline#themes#generate_color_map(s:IA, s:IA, s:IA)
    let g:airline#themes#gruvbox_material#palette.inactive_modified = {
                \ 'airline_c': [ '#d8be95' , s:darker , 223 , s:darker_cterm ] ,
                \ }
