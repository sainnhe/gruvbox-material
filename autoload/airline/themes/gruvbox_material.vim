...
if &background ==# 'light'
    ...
    let s:N2 = [ '#665c54' , '#d5c4a1' , 241 , 250 ] " info
    let s:N3 = [ '#665c54' , '#ebdbb2' , 241 , 223 ] " statusline
    ...
    let g:airline#themes#gruvbox_material#palette.normal_modified = {
                \ 'airline_c': [ '#665c54' , '#ebdbb2' , 241 , 223 ] ,
                \ }

    " Insert mode
    let s:I1 = [ '#ebdbb2' , '#6f8352' , 223 , 100 ]
    let s:I2 = [ '#665c54' , '#d5c4a1' , 241 , 250 ]
    let s:I3 = [ '#665c54' , '#ebdbb2' , 241 , 223 ]
    ...
    let s:R2 = [ '#665c54' , '#d5c4a1' , 241 , 250 ]
    let s:R3 = [ '#665c54' , '#ebdbb2' , 241 , 223 ]
    ...
    let s:V2 = [ '#665c54' , '#d5c4a1' , 241 , 250 ]
    let s:V3 = [ '#665c54' , '#ebdbb2' , 241 , 223 ]
    ...
    " Inactive
    let s:IA = [ '#665c54' , '#ebdbb2' , 241 , 223 ]
