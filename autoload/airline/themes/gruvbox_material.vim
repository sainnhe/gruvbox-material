...
if &background ==# 'light'
    ...
    let s:N2 = [ '#ddc7a1' , s:darkgrey , 223 , s:darkgrey_cterm ] " info
    let s:N3 = [ '#ddc7a1' , s:darker , 223 , s:darker_cterm ] " statusline
    ...
    let s:I2 = [ '#ddc7a1' , s:darkgrey , 223 , s:darkgrey_cterm ]
    let s:I3 = [ '#ddc7a1' , s:darker , 223 , s:darker_cterm ]
    ...
    let s:R2 = [ '#ddc7a1' , s:darkgrey , 223 , s:darkgrey_cterm ]
    let s:R3 = [ '#ddc7a1' , s:darker , 223 , s:darker_cterm ]
    ...
    let s:V2 = [ '#ddc7a1' , s:darkgrey , 223 , s:darkgrey_cterm ]
    let s:V3 = [ '#ddc7a1' , s:darker , 223 , s:darker_cterm ]
