...
if s:configuration.statusline_style ==# 'original' "{{{
  let s:tab_l_fg = s:palette.bg_grey1
  let s:tab_l_bg = s:palette.bg_sl3
  let s:tab_r_fg = s:palette.bg0
  let s:tab_r_bg = s:palette.bg_grey1
  let s:tab_sel_fg = s:palette.bg0
  let s:tab_sel_bg = s:palette.bg_grey1
  let s:tab_middle_fg = s:palette.grey
  ...
  let s:normal_l1_bg = s:palette.bg_grey1
  let s:normal_l2_fg = s:palette.bg_grey1
  let s:normal_l2_bg = s:palette.bg_sl3
  let s:normal_r1_fg = s:palette.bg0
  let s:normal_r1_bg = s:palette.bg_grey1
  let s:normal_r2_fg = s:palette.bg_grey1
  let s:normal_r2_bg = s:palette.bg_sl3
  let s:normal_middle_fg = s:palette.bg_grey1
  let s:normal_middle_bg = s:palette.bg_sl2

  let s:insert_l1_fg = s:palette.bg0
  let s:insert_l1_bg = s:palette.blue
  let s:insert_l2_fg = s:palette.fg1
  let s:insert_l2_bg = s:palette.bg_sl3
  let s:insert_r1_fg = s:palette.bg0
  let s:insert_r1_bg = s:palette.blue
  let s:insert_r2_fg = s:palette.fg1
  let s:insert_r2_bg = s:palette.bg_sl3
  let s:insert_middle_fg = s:palette.fg1
  let s:insert_middle_bg = s:palette.bg_sl3

  let s:visual_l1_fg = s:palette.bg0
  let s:visual_l1_bg = s:palette.orange
  let s:visual_l2_fg = s:palette.fg1
  let s:visual_l2_bg = s:palette.bg_sl3
  let s:visual_r1_fg = s:palette.bg0
  let s:visual_r1_bg = s:palette.orange
  let s:visual_r2_fg = s:palette.fg1
  let s:visual_r2_bg = s:palette.bg_sl3
  let s:visual_middle_fg = s:palette.bg0
  let s:visual_middle_bg = s:palette.bg_grey0

  let s:replace_l1_fg = s:palette.bg0
  let s:replace_l1_bg = s:palette.aqua
  let s:replace_l2_fg = s:palette.fg1
  let s:replace_l2_bg = s:palette.bg_sl3
  let s:replace_r1_fg = s:palette.bg0
  let s:replace_r1_bg = s:palette.aqua
  let s:replace_r2_fg = s:palette.fg1
  let s:replace_r2_bg = s:palette.bg_sl3
  let s:replace_middle_fg = s:palette.fg1
  let s:replace_middle_bg = s:palette.bg_sl3

  let s:command_l1_fg = s:palette.bg0
  let s:command_l1_bg = s:palette.green
  let s:command_l2_fg = s:palette.fg1
  let s:command_l2_bg = s:palette.bg_sl3
  let s:command_r1_fg = s:palette.bg0
  let s:command_r1_bg = s:palette.green
  let s:command_r2_fg = s:palette.fg1
  let s:command_r2_bg = s:palette.bg_sl3
  let s:command_middle_fg = s:palette.fg1
  let s:command_middle_bg = s:palette.bg_sl3

  let s:inactive_l1_fg = s:palette.bg_grey1
  let s:inactive_l1_bg = s:palette.bg_sl2
  let s:inactive_l2_fg = s:palette.bg_grey1
  let s:inactive_l2_bg = s:palette.bg_sl2
  let s:inactive_r1_fg = s:palette.bg_grey1
  let s:inactive_r1_bg = s:palette.bg_sl2
  let s:inactive_r2_fg = s:palette.bg_grey1
  let s:inactive_r2_bg = s:palette.bg_sl2
  let s:inactive_middle_fg = s:palette.bg_grey1
  let s:inactive_middle_bg = s:palette.bg_sl2 "}}}
else "{{{
  ...
  let s:tab_middle_bg = s:palette.bg_sl1
  ...
  let s:normal_middle_bg = s:palette.bg_sl1
  ...
  let s:insert_r2_bg = s:palette.bg_sl3
  let s:insert_middle_fg = s:palette.fg1
  let s:insert_middle_bg = s:palette.bg_sl1
  ...
  let s:visual_middle_bg = s:palette.bg_sl1
  ...
  let s:replace_r2_bg = s:palette.bg_sl3
  let s:replace_middle_fg = s:palette.fg1
  let s:replace_middle_bg = s:palette.bg_sl1
  ...
  let s:command_r2_bg = s:palette.bg_sl3
  let s:command_middle_fg = s:palette.fg1
  let s:command_middle_bg = s:palette.bg_sl1

  let s:inactive_l1_fg = s:palette.fg1
  let s:inactive_l1_bg = s:palette.bg_sl3
  let s:inactive_l2_fg = s:palette.fg1
  let s:inactive_l2_bg = s:palette.bg_sl3
  let s:inactive_r1_fg = s:palette.fg1
  let s:inactive_r1_bg = s:palette.bg_sl3
  let s:inactive_r2_fg = s:palette.fg1
  let s:inactive_r2_bg = s:palette.bg_sl3
  let s:inactive_middle_fg = s:palette.fg1
  let s:inactive_middle_bg = s:palette.bg_sl1
endif "}}}
"}}}
