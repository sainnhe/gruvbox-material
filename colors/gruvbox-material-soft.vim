...
" Last Updated: Mon 22 Jul 2019 01:22:57 PM CST
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  let g:terminal_ansi_colors = ['#32302f', '#ea6962', '#a9b665', '#e3a84e',
  ...
  if get(g:, 'gruvbox_material_enable_bold', 0)
    ...
    hi BlueBold guifg=#85ae9e guibg=NONE guisp=NONE gui=bold cterm=bold
    ...
    hi BlueBold guifg=#85ae9e guibg=NONE guisp=NONE gui=NONE cterm=NONE
  ...
  hi DiffAdd guifg=#a9b665 guibg=#32302f guisp=NONE gui=reverse cterm=reverse
  hi DiffChange guifg=#89b482 guibg=#32302f guisp=NONE gui=reverse cterm=reverse
  hi DiffDelete guifg=#ea6962 guibg=#32302f guisp=NONE gui=reverse cterm=reverse
  hi DiffText guifg=#e3a84e guibg=#32302f guisp=NONE gui=reverse cterm=reverse
  ...
  hi ErrorMsg guifg=#32302f guibg=#ea6962 guisp=NONE gui=NONE cterm=NONE
  hi WarningMsg guifg=#32302f guibg=#e78a4e guisp=NONE gui=NONE cterm=NONE
  ...
  hi IncSearch guifg=#e78a4e guibg=#32302f guisp=NONE gui=reverse cterm=reverse
  hi Search guifg=#e3a84e guibg=#32302f guisp=NONE gui=reverse cterm=reverse
  ...
  hi StatusLineNC guifg=#32302f guibg=#a89984 guisp=NONE gui=reverse cterm=reverse
  ...
  if get(g:, 'gruvbox_material_enable_bold', 0)
    ...
    hi Title guifg=#a9b665 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  ...
  hi! link jsFuncParens Grey
  hi! link jsParens Grey
  ...
  hi! link moonFunction Grey
  hi! link moonObject Yellow
  hi! link javaAnnotation Blue
  hi! link javaDocTags Aqua
  hi! link javaParen Grey
  hi! link javaParen1 Grey
  hi! link javaParen2 Grey
  hi! link javaParen3 Grey
  hi! link javaParen4 Grey
  hi! link javaParen5 Grey
  ...
  hi CtrlPMode2 guifg=#32302f guibg=#85ae9e guisp=NONE gui=bold cterm=bold
...
if s:t_Co >= 256
  ...
  hi ErrorMsg ctermfg=236 ctermbg=167 cterm=NONE
  hi WarningMsg ctermfg=236 ctermbg=208 cterm=NONE
  ...
  hi StatusLineNC ctermfg=236 ctermbg=246 cterm=reverse
  ...
  if get(g:, 'gruvbox_material_enable_bold', 0)
    ...
    hi Title ctermfg=142 ctermbg=NONE cterm=NONE
...
if s:t_Co >= 8
  ...
  if get(g:, 'gruvbox_material_enable_bold', 0)
    ...
    hi Title ctermfg=Green ctermbg=NONE cterm=NONE
