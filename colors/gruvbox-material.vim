...
" Last Updated: Fri 22 Nov 2019 07:52:14 PM CST
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  if &background ==# 'dark'
    ...
    elseif get(g:, 'gruvbox_material_current_word', 'grey background') ==# 'grey background'
      if get(g:, 'gruvbox_material_background', 'medium') ==# 'hard'
        if &background ==#'light'
  ...
  if get(g:, 'gruvbox_material_transparent_background', 0) && !has('gui_running')
    ...
    if get(g:, 'gruvbox_material_background', 'medium') ==# 'hard'
      ...
      hi CursorColumn guifg=NONE guibg=#f3eac7 guisp=NONE gui=NONE cterm=NONE
