...
" Last Updated: Fri 22 Nov 2019 05:35:22 PM CST
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  if &background ==# 'dark'
    ...
    if get(g:, 'gruvbox_material_transparent_background', 0) && !has('gui_running')
      ...
      elseif get(g:, 'gruvbox_material_background', 'medium') ==# 'medium'
        ...
        hi MatchParen guifg=NONE guibg=#45403d guisp=NONE gui=bold cterm=bold
    ...
    if get(g:, 'gruvbox_material_visual', 'darkgreen') ==# 'darkgreen'
      hi! link Visual GruvboxMaterialDarkGreen
      hi! link VisualNOS GruvboxMaterialDarkGreen
    elseif get(g:, 'gruvbox_material_visual', 'darkgreen') ==# 'darkblue'
      hi! link Visual GruvboxMaterialDarkBlue
      hi! link VisualNOS GruvboxMaterialDarkBlue
    elseif get(g:, 'gruvbox_material_visual', 'darkgreen') ==# 'darkred'
    ...
    if get(g:, 'gruvbox_material_search', 'reverse') ==# 'noreverse'
      if get(g:, 'gruvbox_material_background', 'medium') ==# 'hard'
        hi IncSearch guifg=NONE guibg=#333e34 guisp=NONE gui=bold cterm=bold
        hi Search guifg=NONE guibg=#333e34 guisp=NONE gui=underline cterm=underline
      elseif get(g:, 'gruvbox_material_background', 'medium') ==# 'medium'
        hi IncSearch guifg=NONE guibg=#3b4439 guisp=NONE gui=bold cterm=bold
        hi Search guifg=NONE guibg=#3b4439 guisp=NONE gui=underline cterm=underline
      elseif get(g:, 'gruvbox_material_background', 'medium') ==# 'soft'
        hi IncSearch guifg=NONE guibg=#424a3e guisp=NONE gui=bold cterm=bold
        hi Search guifg=NONE guibg=#424a3e guisp=NONE gui=underline cterm=underline
      endif
    else
  ...
  if get(g:, 'gruvbox_material_transparent_background', 0) && !has('gui_running')
    ...
    elseif get(g:, 'gruvbox_material_background', 'medium') ==# 'medium'
      ...
      hi MatchParen guifg=NONE guibg=#e0cfa9 guisp=NONE gui=bold cterm=bold
  ...
  if get(g:, 'gruvbox_material_search', 'reverse') ==# 'noreverse'
    if get(g:, 'gruvbox_material_background', 'medium') ==# 'hard'
      hi IncSearch guifg=NONE guibg=#dde5c2 guisp=NONE gui=bold cterm=bold
      hi Search guifg=NONE guibg=#dde5c2 guisp=NONE gui=underline cterm=underline
    elseif get(g:, 'gruvbox_material_background', 'medium') ==# 'medium'
      hi IncSearch guifg=NONE guibg=#dee2b6 guisp=NONE gui=bold cterm=bold
      hi Search guifg=NONE guibg=#dee2b6 guisp=NONE gui=underline cterm=underline
    elseif get(g:, 'gruvbox_material_background', 'medium') ==# 'soft'
      hi IncSearch guifg=NONE guibg=#d7d9ae guisp=NONE gui=bold cterm=bold
      hi Search guifg=NONE guibg=#d7d9ae guisp=NONE gui=underline cterm=underline
    endif
  else
    hi IncSearch guifg=NONE guibg=NONE guisp=NONE gui=bold,reverse ctermfg=NONE ctermbg=NONE cterm=bold,reverse
    hi Search guifg=NONE guibg=NONE guisp=NONE gui=reverse,underline ctermfg=NONE ctermbg=NONE cterm=reverse,underline
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    if get(g:, 'gruvbox_material_search', 'reverse') ==# 'noreverse'
      if get(g:, 'gruvbox_material_background', 'medium') ==# 'hard'
        ...
        hi Search ctermfg=NONE ctermbg=22 cterm=underline
      elseif get(g:, 'gruvbox_material_background', 'medium') ==# 'medium'
        hi IncSearch ctermfg=NONE ctermbg=22 cterm=bold
        hi Search ctermfg=NONE ctermbg=22 cterm=underline
      elseif get(g:, 'gruvbox_material_background', 'medium') ==# 'soft'
  ...
  if get(g:, 'gruvbox_material_search', 'reverse') ==# 'noreverse'
    if get(g:, 'gruvbox_material_background', 'medium') ==# 'hard'
      hi IncSearch ctermfg=NONE ctermbg=187 cterm=bold
      hi Search ctermfg=NONE ctermbg=187 cterm=underline
    elseif get(g:, 'gruvbox_material_background', 'medium') ==# 'medium'
      hi IncSearch ctermfg=NONE ctermbg=187 cterm=bold
      hi Search ctermfg=NONE ctermbg=187 cterm=underline
    elseif get(g:, 'gruvbox_material_background', 'medium') ==# 'soft'
  ...
  if &background ==# 'dark'
    ...
    if get(g:, 'gruvbox_material_search', 'reverse') ==# 'noreverse'
      if get(g:, 'gruvbox_material_background', 'medium') ==# 'hard'
        ...
        hi Search ctermfg=NONE ctermbg=DarkGreen cterm=underline
      elseif get(g:, 'gruvbox_material_background', 'medium') ==# 'medium'
        hi IncSearch ctermfg=NONE ctermbg=DarkGreen cterm=bold
        hi Search ctermfg=NONE ctermbg=DarkGreen cterm=underline
      elseif get(g:, 'gruvbox_material_background', 'medium') ==# 'soft'
