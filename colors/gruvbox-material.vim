...
" Last Updated: Fri 22 Nov 2019 05:15:45 PM CST
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  if &background ==# 'dark'
    ...
    if get(g:, 'gruvbox_material_visual', 'noreverse') ==# 'noreverse'
      if get(g:, 'gruvbox_material_background', 'medium') ==# 'hard'
        hi Visual guifg=NONE guibg=#333e34 guisp=NONE gui=NONE cterm=NONE
        hi VisualNOS guifg=NONE guibg=#333e34 guisp=NONE gui=NONE cterm=NONE
      elseif get(g:, 'gruvbox_material_background', 'medium') ==# 'medium'
        hi Visual guifg=NONE guibg=#3b4439 guisp=NONE gui=NONE cterm=NONE
        hi VisualNOS guifg=NONE guibg=#3b4439 guisp=NONE gui=NONE cterm=NONE
      elseif get(g:, 'gruvbox_material_background', 'medium') ==# 'soft'
        hi Visual guifg=NONE guibg=#424a3e guisp=NONE gui=NONE cterm=NONE
        hi VisualNOS guifg=NONE guibg=#424a3e guisp=NONE gui=NONE cterm=NONE
      endif
    else
  ...
  if get(g:, 'gruvbox_material_visual', 'noreverse') ==# 'noreverse'
    if get(g:, 'gruvbox_material_background', 'medium') ==# 'hard'
      hi Visual guifg=NONE guibg=#dde5c2 guisp=NONE gui=NONE cterm=NONE
      hi VisualNOS guifg=NONE guibg=#dde5c2 guisp=NONE gui=NONE cterm=NONE
    elseif get(g:, 'gruvbox_material_background', 'medium') ==# 'medium'
      hi Visual guifg=NONE guibg=#dee2b6 guisp=NONE gui=NONE cterm=NONE
      hi VisualNOS guifg=NONE guibg=#dee2b6 guisp=NONE gui=NONE cterm=NONE
    elseif get(g:, 'gruvbox_material_background', 'medium') ==# 'soft'
      hi Visual guifg=NONE guibg=#d7d9ae guisp=NONE gui=NONE cterm=NONE
      hi VisualNOS guifg=NONE guibg=#d7d9ae guisp=NONE gui=NONE cterm=NONE
    endif
  else
    hi Visual guifg=NONE guibg=NONE guisp=NONE gui=reverse ctermfg=NONE ctermbg=NONE cterm=reverse
    hi VisualNOS guifg=NONE guibg=NONE guisp=NONE gui=reverse ctermfg=NONE ctermbg=NONE cterm=reverse
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    if get(g:, 'gruvbox_material_visual', 'noreverse') ==# 'noreverse'
      if get(g:, 'gruvbox_material_background', 'medium') ==# 'hard'
        ...
        hi VisualNOS ctermfg=NONE ctermbg=22 cterm=NONE
      elseif get(g:, 'gruvbox_material_background', 'medium') ==# 'medium'
        hi Visual ctermfg=NONE ctermbg=22 cterm=NONE
        hi VisualNOS ctermfg=NONE ctermbg=22 cterm=NONE
      elseif get(g:, 'gruvbox_material_background', 'medium') ==# 'soft'
  ...
  if get(g:, 'gruvbox_material_visual', 'noreverse') ==# 'noreverse'
    if get(g:, 'gruvbox_material_background', 'medium') ==# 'hard'
      ...
      hi VisualNOS ctermfg=NONE ctermbg=187 cterm=NONE
    elseif get(g:, 'gruvbox_material_background', 'medium') ==# 'medium'
      hi Visual ctermfg=NONE ctermbg=187 cterm=NONE
      hi VisualNOS ctermfg=NONE ctermbg=187 cterm=NONE
    elseif get(g:, 'gruvbox_material_background', 'medium') ==# 'soft'
...
if s:t_Co >= 8
  if &background ==# 'dark'
    ...
    if get(g:, 'gruvbox_material_visual', 'noreverse') ==# 'noreverse'
      if get(g:, 'gruvbox_material_background', 'medium') ==# 'hard'
        hi Visual ctermfg=NONE ctermbg=DarkGreen cterm=NONE
        hi VisualNOS ctermfg=NONE ctermbg=DarkGreen cterm=NONE
      elseif get(g:, 'gruvbox_material_background', 'medium') ==# 'medium'
        hi Visual ctermfg=NONE ctermbg=DarkGreen cterm=NONE
        hi VisualNOS ctermfg=NONE ctermbg=DarkGreen cterm=NONE
      elseif get(g:, 'gruvbox_material_background', 'medium') ==# 'soft'
